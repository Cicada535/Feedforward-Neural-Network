...
[^2]:
- **learning_rate_t** - шаг обучения на этапе t
- **learning_rate_0** - начальный шаг обучения
- **decay_rate** - скорость уменьшения шага обучения (обычно небольшое положительное число)
- **t** - номер текущего этапа обучения
